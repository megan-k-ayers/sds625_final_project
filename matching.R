...
# Pretty low, positive difference (happening is a percent, not a proportion).
mean(x_t$happening - x_c$happening)


#### Could try the same just with hurricanes? Does the avg belief in climate
# change differ with the type of weather experienced?
